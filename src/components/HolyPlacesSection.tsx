...
export default function HolyPlacesSection() {
  ...
  return (
    <section id="places" ref={ref} className="relative py-20 md:py-32 bg-gradient-to-b from-muted to-background overflow-hidden">
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 bg-gradient-to-r from-peacock via-gold to-saffron bg-clip-text text-transparent">
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="bg-gradient-to-r from-peacock/10 via-gold/10 to-transparent rounded-xl p-4 border-l-4 border-peacock">
                    <div className="flex items-start gap-2">
                      <Info className="w-5 h-5 text-peacock mt-0.5 flex-shrink-0" />
                      <div>
                        <h4 className="text-sm font-bold text-foreground mb-1">Significance</h4>
